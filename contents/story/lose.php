    ...
    <body>
		<div align="center">
			...
			<div class="form-box-non">
				...
				<button class="btn-square1" onclick="location.href='../../controller.php?mypokemon=<?php echo $mypokemon->identify ?>&process=102&gymleader=<?php echo $gymleader->identify ?>'">>>もういちどたたかう<<</button>
	            <button class="btn-square2" onclick="location.href='mypokemon.php'">>>さいしょにもどる<<</button>
			</div>
		</div>
    </body>
</html>
